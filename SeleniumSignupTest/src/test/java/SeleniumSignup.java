...
public class SeleniumSignup {
    ...
    public void positiveSignUp() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"user_username\"]")).sendKeys("jide01");
        //6. Input an email address on the email field
        driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("jide01@mailinator.com");
        //7. Input your password on the password field
        driver.findElement(By.xpath("//*[@id=\"user_password\"]")).sendKeys("jide");
    ...
    public void negativeSignUp() throws InterruptedException {
        ...
        //5. Input your username on the username field
        driver.findElement(By.xpath("//*[@id=\"user_username\"]")).sendKeys("ji");
        //6. Input an email address on the email field
        driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("jide01@mailinator.com");
        //7. Input your password on the password field
        driver.findElement(By.xpath("//*[@id=\"user_password\"]")).sendKeys("jide");
    ...
    public void invalidEmail() throws InterruptedException {
        ...
        //5. Input your username on the username field
        driver.findElement(By.xpath("//*[@id=\"user_username\"]")).sendKeys("jide");
        //6. Input an email address on the email field
        driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("jide01mailinator.com");
        //7. Input your password on the password field
        driver.findElement(By.xpath("//*[@id=\"user_password\"]")).sendKeys("jide");
        //8. Click on the signup button
        driver.findElement(By.xpath("//*[@id=\"submit\"]")).click();
